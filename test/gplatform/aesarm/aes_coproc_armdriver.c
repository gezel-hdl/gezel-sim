...
// $Id: aes_coproc_armdriver.c,v 1.1.1.1 2005/07/14 17:32:45 schaum Exp $
...
void aes(int key1, int key2, int key3, int key4, int text1, int text2, int text3, int text4); /* hw version */

void aes_sw(int key1, int key2, int key3, int key4, int text1, int text2, int text3, int text4); /* sw version */

int main() {

      aes   (0x00010203, 0x04050607, 0x08090a0b, 0x0c0d0e0f, 
...
void aes_sw(int key1, int key2, int key3, int key4, int text1, int text2, int text3, int text4) {
  u8 key_c[16];
  u8 din_c[16];
  u8 dout_c[16];
  int i;
  ...
  /* Key scheduling */
  RijndaelKeySchedule(key_c);
  RijndaelEncrypt(din_c,dout_c);
  /*
...
void aes(int key1, int key2, int key3, int key4, int text1, int text2, int text3, int text4) {
  int text_out1, text_out2, text_out3, text_out4;
...
#define AESDO(INS, DIN) *din = DIN; *ins = INS
  ...
  AESDO(ins_load, text1); 
  AESDO(ins_idle, 0); 
  AESDO(ins_load, text2); 
  AESDO(ins_idle, 0); 
  AESDO(ins_load, text3); 
  AESDO(ins_idle, 0); 
  AESDO(ins_text,  text4); 
  AESDO(ins_idle, 0); 
  ...
  // single-sided handshake - just need to wait some time
  ...
  printf("text_out %x %x %x %x\n", text_out1, text_out2, text_out3, text_out4); 
