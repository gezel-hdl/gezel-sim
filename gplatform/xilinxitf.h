...
// Simple Memory-mapped register(s) attached to PLB (EDK 9.2)
//
...
// $option "attribute_def user_logic SIGIS string"
// $option "attribute_use user_logic SIGIS Bus2IP_Clk   CLK"
// $option "attribute_use user_logic SIGIS Bus2IP_Reset RST"
//
// ipblock reg3(out Bus2IP_Data    : ns(32); // 0 to dwidth-1
//              out Bus2IP_BE      : ns(4);  // 0 to dwidth/8 - 1
//              out Bus2IP_RdCE    : ns(4);  // 0 to c_num_ce - 1
...
class xilinx_plb_ipif_reg : public aipblock {
  arm_simulator  *hook; 
  int             regid_dev;
  int             opid_dev;
  int             data_dev;
